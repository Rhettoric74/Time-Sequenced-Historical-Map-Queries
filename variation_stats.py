...
if __name__ == "__main__":
    ...
    for city in cities:
        ...
        print(accounts)
        print(len(accounts)) """
    plot_named_accounts(list_accounts_in_order("analyzed_cities/dushanbe_dates.json", True, 70))
    plot_named_accounts(list_accounts_in_order("analyzed_cities/dushanbe_dates.json"))
