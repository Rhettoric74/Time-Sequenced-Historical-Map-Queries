...
if __name__ == "__main__":
    ...
    print(queries)
    print(os.path.isdir("C:/Users/rhett/code_repos/Time-Sequenced-Historical-Map-Queries/scripts/multiword_queries/multiword_query_results/most_populous_multiword_cities/"))
    for query in queries:
        try:
            print(query)
            ...
            with open("C:/Users/rhett/code_repos/Time-Sequenced-Historical-Map-Queries/scripts/multiword_queries/multiword_query_results/most_populous_multiword_cities/" + query + "_dates.json", "w", encoding="utf-8") as fw:
                json.dump(query_results, fw)
